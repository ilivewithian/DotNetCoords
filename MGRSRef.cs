...
namespace DotNetCoords
{
  ...
  public class MGRSRef : CoordinateSystem 
  {
     ...
     * 
     */
    private readonly int utmZoneNumber;

    /**
     * 
     */
    private readonly char utmZoneChar;

    /**
     * 
     */
    private readonly char eastingID;

    /**
     * 
     */
    private readonly char northingID;
    ...
    {
      private long letter;            /* letter representing latitude band  */
      internal readonly double min_northing;    /* minimum northing for latitude band */
    ...
    */
    { /* BEGIN Get_Grid_Values */
      ...
      long set_number = utmZoneNumber % 6;
    ...
    public UTMRef ToUTMRef() 
    {
      ...
      * Also check that the third letter is valid */
      ...
      double grid_northing = offsetNorthing * 100000.0 + false_northing;
