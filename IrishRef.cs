...
namespace DotNetCoords
{
  ...
  public class IrishRef : CoordinateSystem 
  {
    ...
    private const double FALSE_ORIGIN_LATITUDE = 53.5;

    private const double FALSE_ORIGIN_LONGITUDE = -8.0;

    private const double FALSE_ORIGIN_EASTING = 200000.0;

    private const double FALSE_ORIGIN_NORTHING = 250000.0;
    ...
    public IrishRef(LatLng ll) : base(Ireland1965Datum.Instance)
    {
      ...
      const double N0 = FALSE_ORIGIN_NORTHING;
      const double E0 = FALSE_ORIGIN_EASTING;
